...
pub fn argon2_custom(
    ...
    let params = match params {
        ...
        Params::Custom {
            ...
            t_cost,
            p_cost,
        } => argon2::Params::new(m_cost, t_cost, p_cost, Some(SIZE_32)).map_err(|_| Error::new(ErrorKind::Dummy, String::default()))?,
    };
...
/// ```
pub fn digest(argon2: &argon2::Argon2, password: &[u8], salt: &[u8]) -> Result<[u8; SIZE_32]> {
